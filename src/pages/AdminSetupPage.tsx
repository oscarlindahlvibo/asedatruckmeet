    ...
    <div className="min-h-screen bg-ink-900 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-card p-8 md:p-10">
          ...
          <div className="flex gap-2 items-start text-sm text-white/60 leading-relaxed mb-7"><ShieldCheck className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />Detta fungerar endast så länge ingen admin ännu är skapad. Därefter stängs funktionen automatiskt.</div>
